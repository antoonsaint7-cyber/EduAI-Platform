...
const ARABIC_ORDINALS = 'الأولى|الأول|الثانية|الثاني|الثالثة|الثالث|الرابعة|الرابع|الخامسة|الخامس|السادسة|السادس|السابعة|السابع|الثامنة|الثامن|التاسعة|التاسع|العاشرة|العاشر';
const HEADING_PATTERNS = [
  /^(?:unit|lesson|chapter)\s+(?:\d+|[ivxlcdm]+)(?:\s|$)/i,
  /^(?:وحدة|درس|فصل)\s+(?:\d+|[٠-٩]+|[اأإآبجدهـوحطيكلمنسعفصقرشتثخذضظغ]+)(?:\s|$)/u,
  new RegExp(`^(?:الوحدة|الدرس|الفصل)\\s+(?:\\d+|[٠-٩]+|[اأإآبجدهـوحطيكلمنسعفصقرشتثخذضظغ]+|${ARABIC_ORDINALS})(?:\\s|$)`, 'u')
];
